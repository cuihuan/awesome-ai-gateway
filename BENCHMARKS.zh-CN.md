...
| **Requesty** | ★★★½ | ~5% | ★★★½ | ★★★ | ★★★ | 欧盟驻留 + PII 脱敏 + ZDR；SOC 2 Type II"进行中——预计 2026 Q3"（已从 Q2 推迟；厂商 FAQ 的标注与其徽章自相矛盾）。Q3 已是当前季度，采信前请自行核实最新状态 |
