...
- **Scale — no reliable public figure.** Anthropic's [Transparency Hub](https://www.anthropic.com/transparency) publishes no account-enforcement statistics, and the third-party ban guides in circulation (e.g. [this one](https://teamorouter.com/blogs/claude-code-banned-guide)) document the ban/appeal process without aggregate numbers (both checked 2026-07-27). Treat any "X accounts banned" total you see quoted as unsourced.
