...
|---|---|---|---|---|---|
| **LiteLLM** | Python | Breadth (100+ providers), features | 5.41 ms | MIT | <!--s:BerriAI/litellm-->⭐ 55k<!--/s--> |
| **Bifrost** | Go | Raw throughput | 0.56 ms | Apache-2.0 | <!--s:maximhq/bifrost-->⭐ 6.9k<!--/s--> |
